...
Review.create(star_rating: 2, restaurant_id: 1, customer_id: 5)
Review.create(star_rating: 12, restaurant_id: 2, customer_id: 4)
Review.create(star_rating: 112, restaurant_id: 3, customer_id: 3)
Review.create(star_rating: 232, restaurant_id: 3, customer_id: 2)
Review.create(star_rating: 233, restaurant_id: 1, customer_id: 1)
